...
const firebaseConfig = {
    apiKey: "AIzaSyBhjnl5Xw916c9qUBuxLInTGTxqiCb3n34",
    authDomain: "mmmproject-5c97f.firebaseapp.com",
    projectId: "mmmproject-5c97f",
    storageBucket: "mmmproject-5c97f.firebasestorage.app",
    messagingSenderId: "623476923226",
    appId: "1:623476923226:web:1ae823850315d54f543163",
    measurementId : "G-SVFLJWXGWK",
};
...
self.addEventListener("notificationclick", (event) => {
    ...
    // http://localhost:5173은 기본 도메인으로, 상대 경로와 결합하여 최종 URL을 만듭니다.
    const urlToOpen = new URL(landingPath, "https://j12c207.p.ssafy.io/");
    ...
    event.waitUntil(
        clients.matchAll({
            ...
            for (let client of windowClients) {
                if (client.url.includes("https://j12c207.p.ssafy.io/") && "focus" in client) {
